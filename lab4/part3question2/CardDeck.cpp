...
void CardDeck::emptyDeck() {
	deck.clear() ;
}

void CardDeck::addEndCard(int value) {
	deck.push_back(value) ;
}

int CardDeck::removeTopCard() {
	int value = deck[0] ;	//value of 0th element of deck (the top of the deck)
	deck.pop_front() ;	//removes 0th element from deck
	return value ;
