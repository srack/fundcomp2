/*  Samantha Rack, C4Col.cpp
	CSE 20212, Lab 2
	This file contains the implementation of member functions of the class C4Col.  It includes a default constructor, initializing the column,
	and various member functions to perform operations on the column.
*/
...
char C4Col::getDisc(int discNumber) const {
...
int C4Col::getMaxDiscs() const {		//get function for private variable maxDisks
	return maxDiscs ;
}
...
C4Col C4Col::operator+=(char newDisc) { //overload of += operator, returns current C4Col object
	addDisc(newDisc) ;
	return (*this) ;
}
