...
class OvernightPackage: public Package {
	public:
		...
		virtual double calculateCost() ;	//includes extra charge per ounce, virtual function
		virtual void printLabel() ;	//virtual function inplemented in TwoDayPackage.cpp
